...
class SubflowGenSection(AbstractSubflow):
    ...
    def run_subflow(
        ...
        return _subflow_gen_section_by_plan(
            exec_info=exec_info,
...
def _subflow_gen_section_by_plan(
    exec_info: ExecInfo,
    section_plan: ArticleSectionPlan,
    accumulated_source_items: Dict[str, SourceItem],
    previous_sections: List[ArticleSection],
    ...
    # rewritten_query = step_rag._run_rewriter(
    #     exec_info=exec_info,
    #     rewrite_section=strategy.strategy_sections.get(
