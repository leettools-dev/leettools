...
class AbstractParser(ABC):
    ...
    @abstractmethod
    def docx2md(self, docx_path: str) -> str:
        """
    ...
    def file2md(self, file_path: str) -> str:
        """
        ...
        if file_ext == PDF_EXT:
            return self.pdf2md(file_path)
        elif file_ext == DOCX_EXT:
            return self.docx2md(file_path)
        elif file_ext == PPTX_EXT:
            return self.pptx2md(file_path)
        elif file_ext == XLSX_EXT or file_ext == XLS_EXT:
            return self.xlsx2md(file_path)
        else:
