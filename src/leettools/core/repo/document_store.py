...
class AbstractDocumentStore(ABC):
    ...
    # Add a flag to indicate if we want the content in the results
    ...
    def get_documents_by_docsourcetype(
        ...
        """
        Get all documents from the store for a given docsource type. If no docsource
        type is provided, all documents will be returned.

        Args:
        - org: The organization.
        - kb: The knowledgebase.
        - docsource_type: The docsource type to get documents for.

        Returns:
        - A dictionary of docsource type to list of documents.
        """
        pass
