...
Here is an illustration of the LeetTools **digest** flow where it can scrape the web
and generate a digest article from the search results:

![LeetTools Digest Flow](docs/assets/process-digest.svg)
